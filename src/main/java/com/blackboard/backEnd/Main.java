 ...
 * This project is a simple front end and backend product that displays student information
 * from a database and allows users to manually upload student files which are then inserted
